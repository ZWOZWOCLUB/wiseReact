...
function Header() {
    return (
        <nav
            className={[
                coreCSS[`layout-navbar`],
                coreCSS[`container-xxl`],
                coreCSS[`navbar`],
                coreCSS[`navbar-expand-xl`],
                thenmeCSS[`navbar-detached`],
                coreCSS[`align-items-center`],
                coreCSS[`bg-navbar-theme`],
            ]}
            id='layout-navbar'
        >
            <div
                className={[
                    coreCSS[`layout-menu-toggle`],
                    coreCSS[`navbar-nav`],
                    coreCSS[`align-items-xl-center`],
                    coreCSS[`me-3 me-xl-0`],
                    coreCSS[`d-xl-none`],
                ]}
            >
            ...
            >
                ...
                >
                    <li className={[coreCSS[`nav-item`], coreCSS[`lh-1`], coreCSS[`me-3`]]}>공지</li>
                    <li className='nav-item lh-1 me-3'>알림</li>
                    <li className='nav-item lh-1 me-3'>쪽지</li>
