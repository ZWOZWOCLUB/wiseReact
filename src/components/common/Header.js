...
function Header() {
    ...
    return (
        <>
            ...
            <nav
                className={`${coreCSS[`layout-navbar`]} ${coreCSS[`container-xxl`]} ${coreCSS[`navbar`]} ${
                    coreCSS[`navbar-expand-xl`]
                } ${coreCSS[`navbar-detached`]} ${coreCSS[`align-items-center`]} ${themDefaultCSS[`bg-navbar-theme`]}`}
                id='layout-navbar'
            >
                <div
                    className={`${coreCSS[`navbar-nav-right`]} ${coreCSS[`d-flex`]} ${coreCSS[`align-items-center`]}`}
                    id='navbar-collapse'
                >
                    <div>
                        <div>
                ...
                <ul
                    className={`${coreCSS[`navbar-nav`]} ${coreCSS[`flex-row`]} ${coreCSS[`align-items-center`]} ${
                        coreCSS[`ms-auto`]
                    }`}
                >
                    <li
                    ...
                    {/* 공지사항? */}
                    <li
                        className={`${coreCSS[`nav-item`]} ${coreCSS[`lh-1`]} ${coreCSS[`me-3`]}`}
                        style={notice ? { color: '#697a8d' } : { color: 'red' }}
                    >
                        <i className='bx bxs-megaphone' style={{ fontSize: 27 }} onClick={onClickNotice} />
                    </li>
                    ...
                    >
                        <i className='bx bxs-bell' style={{ fontSize: 27 }} onClick={onClickAlarm} />
                    </li>
                    ...
                    >
                        <i className='bx bxs-envelope' style={{ fontSize: 27 }} onClick={handleColorChange} />
                    </li>
                    ...
                    >
                        <i class='bx bxs-user-rectangle' style={{ fontSize: 29, color: '#696cff' }} />
                        {/* <img
                src={profile}
                alt=""
                                    ...
                                    {perAlarmList &&
                                        perAlarmList.map((perAlarm) => (
                                            ...
                                            >
                                                ...
                                                <div>
                                                    결재코드 {perAlarm.appCode} 번이 {perAlarm.appState} 되었습니다.{' '}
                                                </div>
                                            </div>
                                        ))}
                                </div>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <button
                                                        ...
                                                        onClick={() => onClickRecMsgDelete(recMessage?.msgCode)}
                                                    >
                                                        X
                                                    </button>
                                                </div>
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <button
                                                        ...
                                                        onClick={() => onClickSendMsgDelete(sendMessage?.msgCode)}
                                                    >
                                                        X
                                                    </button>
                                                </div>
                        ...
                        <div className='modal-body'>
                            ...
                            <div>
                                <CheckboxTree
                                    ...
                                    checked={checked}
                                    expanded={expanded}
                                    onCheck={checked !== undefined ? (checked) => setChecked(checked) : ''}
