...
const onClickDown = async (index) => { // index = convertFileName
...
// document.body.removeChild(link);
      ...
      // link.setAttribute('download', prevList.salaryFileDTO.salAtcConvertName);//다운로드 파일 이름 지정
      // document.body.appendChild(link);
                                ...
                                <tr style={{ textAlign: "center" }} className="List">
                                  ...
                                  <td>
                                    <i
                                      ...
                                      onClick={() => onClickDown(documentFileDTOList.docAtcConvertName)}
                                    />
                                  </td>
                                </tr>
                                    )
