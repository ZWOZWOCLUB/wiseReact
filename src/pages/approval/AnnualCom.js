...
function AnnualCom(props) {
  ...
  console.log(
    "propsCode",
    props.data?.approvalComplete[0]?.approval.approvalMember.memCode
  );
  ...
  return (
    <>
      {props.data?.approvalComplete[0]?.appState !== "대기" ? (
        <div>
          <div id="appDiv">
            <h1 style={{ color: "#bbbdfc" }}>
              {props.data?.approvalComplete[0]?.appState}
            </h1>
          </div>
          <div id="appComentBox">
            <span>결재의견 </span>
      ...
      <div className="approvalTemp">
        ...
        <div id="margintop">
          ...
          <div>
            {props.data.approvalType?.vacStartDate} ~{" "}
            {props.data.approvalType?.vacEndDate}
          </div>
